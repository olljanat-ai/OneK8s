...
output "redis_endpoint" {
  description = "host:port of the shared Memorystore cluster, or null when the tenant has no Redis access."
  value       = var.redis_enabled ? "${var.redis_host}:${var.redis_port}" : null
}
